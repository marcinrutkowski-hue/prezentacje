...
OTWARCIE (S1–S3) — strach, nie brak budżetu
  S1  Hook / pytanie          "Kiedy ostatnio straciłeś zamówienie przez excel?"
  S2  Mit nr 1                "Najpierw musicie wymienić ERP" — kto to słyszał?
  S3  Koszt stania w miejscu  Ręczne dane, błędy, handlowcy jako operatorzy

DYLEMAT (S4–S5) — pozorny wybór
  S4  Big bang vs. czekanie   12+ miesięcy i 100-500k vs. blokada wzrostu
  S5  Trzecia droga           Warstwa commerce nad ERP — nie zamiast

DOWÓD (S6–S8) — jak to działa
  S6  6 metod integracji      REST, SOAP, views, procedury, pliki, webhooks
  S7  Case studies            HAYNE, RESPOL, OCHNIK, BIALCON — realne ERP-y
  S8  ERP zostaje             Zero zmian w pracy zespołu. Synchronizacja w tle

WARTOŚĆ (S9–S12) — co firma zyskuje
  S9  Gotowe funkcje B2B      Cenniki, hierarchie, workflow, budżety out-of-box
  S10 Automatyzacja           AI: quoting, limity, routing, dokumenty
  S11 Biznes bez IT           Zespół zmienia procesy bez angażowania developerów
  S12 Jeden ekosystem         Koniec silosów: ERP, PIM, CRM, logistyka w centrum

ROZDZIELENIE DECYZJI (S13) — kluczowy argument
  S13 Dwie niezależne decyzje eCommerce i ERP to dwa projekty — nie jeden

ZAMKNIĘCIE (S14–S15) — skala i krok
  S14 Co zyskujesz            Skala bez proporcjonalnego wzrostu zespołu
  S15 Następny krok           Nie projekt — rozmowa o Twoim stacku i bólu
```
